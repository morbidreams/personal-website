  ...
  const experience = [
    {
      ...
      responsibilities: [
        "Built and improved features for renoquotes.com that connects clients with contractors for renovation projects.",
        "Built new features, resolved bugs, and optimized UX across the platform handling several API-connected microservices.",
        "Collaborated with the team to build and maintain a Storybook UI component library based on atomic design for consistent and scalable frontend components.",
        "Opened focused pull requests and reviewed teammate code with attention to clarity, test coverage, and edge cases.",
        "Wrote unit tests and end-to-end tests and enforced code standards and health using ESLint and SonarQube in CI pipelines.",
        ...
        "Collaborated closely with developers, product managers and UI/UX designers in an Agile environment using Kanban and Scrum, exchanging ideas and feedback.",
      ],
    },
    {
    ...
    },
    {
      ...
      responsibilities: [
        "Built the backend and frontend of the company's new website.",
